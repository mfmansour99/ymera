...
class DataEncryption:
    """Placeholder for DataEncryption class."""
...
def sanitize_sensitive_data(data: Dict[str, Any], sensitive_fields: Set[str]) -> Dict[str, Any]:
    """Recursively sanitizes sensitive data within a dictionary."""
    sanitized_data = {}
    for key, value in data.items():
        if isinstance(value, dict):
            sanitized_data[key] = sanitize_sensitive_data(value, sensitive_fields)
