...
from .log_formatters import JSONLogFormatter, StructuredTextFormatter
from .log_handlers import EnhancedRotatingFileHandler, RemoteHTTPHandler, FileHandlerConfig
    ...
    def _setup_handlers(self) -> None:
        ...
        if self.config.enable_console_logging:
            ...
            if self.config.environment == "development":
                console_handler.setFormatter(StructuredTextFormatter(use_colors=True, pretty_print=True))
            else:
        ...
        if self.config.enable_file_logging:
            ...
            file_handler = EnhancedRotatingFileHandler(file_handler_config)
        ...
        if self.config.enable_remote_logging and self.config.remote_log_endpoint:
            ...
            remote_handler.setFormatter(JSONLogFormatter())
